...
def run_script(script_name, args=None):
    ...
    try:
        ...
        # Print captured output to show convergence results
        ...
        print(f"✓ Completed in {elapsed:.1f} seconds" + " " * 20)
        return True
...
def main():
    ...
    print("#"*70)
    if not run_script(str(BASE_DIR / 'src' / 'windfoil_optimization_viterna.py')):
    ...
    print("#"*70)
    if not run_script(str(BASE_DIR / 'src' / 'enhanced_analysis.py'), ['--dir', str(RESULTS_DIR)]):
