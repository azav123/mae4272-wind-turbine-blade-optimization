...
parser.add_argument('--dir', type=str, default='output/viterna_corrigan',
                    help='Directory containing optimization results (default: output/viterna_corrigan)')
...
df_results = pd.read_csv(os.path.join(OUTPUT_DIR, 'optimal_blade_parameters.csv'))
...
try:
    with open(os.path.join(OUTPUT_DIR, 'optimal_blade_parameters.csv'), 'r') as f:
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'smooth_pitch_analysis.png'), dpi=300)
print(f"\nPlot saved to '{os.path.join(OUTPUT_DIR, 'smooth_pitch_analysis.png')}'")
...
df_smooth.to_csv(os.path.join(OUTPUT_DIR, 'smoothed_blade_parameters.csv'), index=False)
print(f"Smoothed parameters saved to '{os.path.join(OUTPUT_DIR, 'smoothed_blade_parameters.csv')}'")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'power_vs_rpm_analysis.png'), dpi=300)
print(f"\nPlot saved to '{os.path.join(OUTPUT_DIR, 'power_vs_rpm_analysis.png')}'")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'smoothed_power_vs_rpm_analysis.png'), dpi=300)
print(f"\nPlot saved to '{os.path.join(OUTPUT_DIR, 'smoothed_power_vs_rpm_analysis.png')}'")
