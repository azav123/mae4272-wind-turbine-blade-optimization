...
ax.set_title('Torque vs RPM (0-2000 RPM Range) [3 blades]')
ax.legend()
...
ax.set_xlabel('RPM')
ax.set_ylabel('Torque (N·cm) [3 blades]')
ax.set_title('Torque vs RPM (0-3000 RPM Range) [3 blades]')
ax.legend()
ax.grid(True, alpha=0.3)
...
ax.set_title('Power vs RPM (0-2000 RPM Range) [3 blades]')
ax.legend()
ax.grid(True, alpha=0.3)
...
ax.set_xlabel('RPM')
ax.set_ylabel('Power Output (W) [3 blades]')
ax.set_title('Power vs RPM (0-3000 RPM Range) [3 blades]')
ax.legend()
ax.grid(True, alpha=0.3)
