...
def create_blade_geometry(pitch_angles, chord_distribution='linear'):
    """
    ...
    chord_distribution : str
        Method for chord distribution ('linear', 'constant', etc.)
    ...
    # Chord distribution (simple linear taper for now)
    if chord_distribution == 'linear':
